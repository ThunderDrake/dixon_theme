...
class Assets {
	...
	public function attach_assets() {
		...
		if(is_front_page() || is_page_template( ['templates/credit-page/credit-page.php', 'templates/delivery-page/delivery-page.php', 'templates/contact-page/contact-page.php'] )){
